...
export default function WorkingWithObjects() {
    const [module, setModule] = useState({
        ...
        description: "The first week is the introdction to the class",
    ...
    return (
        <div id="wd-working-with-objects">
            ...
            <a id="wd-retrieve-assignments" className="me-2 btn btn-primary"
                href={ASSIGNMENT_API_URL}>
                Get Assignment
            </a>
            <a id="wd-retrieve-modules" className="me-2 btn btn-primary" href={MODULE_API_URL}>
                Get Module
            </a><hr />
            ...
            <div className="d-flex align-items-center">
                <input className="form-control w-30" id="wd-assignment-score"
                    value={assignment.score}
                    onChange={(e) => setAssignment((old) => ({ ...old, score: parseInt(e.target.value) }))} />
